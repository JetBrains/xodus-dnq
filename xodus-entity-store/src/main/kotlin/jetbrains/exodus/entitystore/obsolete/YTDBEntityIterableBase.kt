...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBFirstSelect
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBLastSelect
...
abstract class YTDBEntityIterableBase(tx: YTDBStoreTransaction) : YTDBEntityIterable {
    ...
    override fun union(right: EntityIterable): EntityIterable {
        if (right == GremlinEntityIterable.Companion.EMPTY) {
            return this
        }
    ...
    override fun intersectSavingOrder(right: EntityIterable): EntityIterable {
        if (right == GremlinEntityIterable.Companion.EMPTY) {
            return GremlinEntityIterable.Companion.EMPTY
        }
    ...
    override fun findLinks(entities: EntityIterable, linkName: String): EntityIterable {
        if (entities == GremlinEntityIterable.Companion.EMPTY) {
            return GremlinEntityIterable.Companion.EMPTY
        }
